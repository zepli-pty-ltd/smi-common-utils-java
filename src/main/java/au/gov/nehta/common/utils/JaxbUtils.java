...
public final class JaxbUtils {
     ...
     * jakarta.xml.bind.Unmarshaller#unmarshal(Source)}.
     *
     * @param <T>
     ...
     * the 'xmlNode'.
     * @throws JAXBException If there is a problem with unmarshalling.
     */
     ...
     * jakarta.xml.bind.Marshaller#marshal(Object, Writer)}. A JAXBElement can be
     ...
     * @throws JAXBException If there is a problem with marshalling.
     ...
     * simplifies the call to the method: {@code
     * jakarta.xml.bind.Marshaller#marshal(Object, Node)}. A JAXBElement can be
     * created from the ObjectFactory generated by JAXB for each package.
     *
     * @param value JAXBElement to marshal into XML data. Cannot be null.
     * @return XML DOM representation of the JAXBElement.
     * @throws JAXBException                If there is a problem with marshalling.
     * @throws ParserConfigurationException If there is a config problem.
     */
